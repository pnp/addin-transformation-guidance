...
![The UI of a custom MessageBar in a header in the modern UI of SharePoint Online.](./assets/From-Notifications-to-Application-Customizers/From-Notifications-to-Application-Customizers-Header-output.png)
