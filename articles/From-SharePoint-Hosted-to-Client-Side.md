...
![The UI of the scaffolding tool in a PowerShell window, while creating a new project for a SharePoint Framework modern web part.](./assets/From-SharePoint-Hosted-to-Client-Side/From-SharePoint-Hosted-to-Client-Side-generator.png)
