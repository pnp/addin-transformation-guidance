...
With the SharePoint Add-in model you can create workflow apps running in a SharePoint-hosted add-in. You simply need to create a SharePoint Add-in model solution, choose to create a SharePoint-hosted app, and add an item of type Workflow to the project. By default, the created workflow will run in the SharePoint-hosted app site, and will target lists or libraries in that site. If you configure the workflow properties to be an *"Integrated App"* you can also run the workflow in the host site, instead of the app site.
...
![The Visual Studio designer for a sequential workflow. There is an initial approval task, followed by an if branch to evaluate the outcome of the approval task. Based on the outcome the workflow updates the approval status of the target item and sends an informative email.](./assets/From-Workflow-Apps-to-Power-Automate/From-Workflow-Apps-to-Power-Automate-VS2019-04.png)
...
![The command bar menu to start creating a new Power Automate flow from within the context of a SharePoint Online list.](./assets/From-Workflow-Apps-to-Power-Automate/From-Workflow-Apps-to-Power-Automate-SPO-UI-01.png)
...
![The side panel in a SharePoint Online list to choose a Power Automate flow template to start from, when creating a new flow. There are plenty of templates available, including the *"Start approval when a new item is added"* flow template.](./assets/From-Workflow-Apps-to-Power-Automate/From-Workflow-Apps-to-Power-Automate-SPO-UI-02.png)
...
![The Microsoft Power Automate flow designer hosted in the browser. There is the design of the flow with the pre-defined template for a SharePoint item approval.](./assets/From-Workflow-Apps-to-Power-Automate/From-Workflow-Apps-to-Power-Automate-SPO-UI-04.png)
...
![The Microsoft Power Automate flow designer with an error highlighted. The error is "'Assigned To' is required".](./assets/From-Workflow-Apps-to-Power-Automate/From-Workflow-Apps-to-Power-Automate-SPO-UI-05.png)
...
![The Microsoft Power Automate "Add an action" button in the flow designer.](./assets/From-Workflow-Apps-to-Power-Automate/From-Workflow-Apps-to-Power-Automate-SPO-UI-06.png)
...
![The Microsoft Power Automate "Choose an operation" box in the flow designer, with the "Update item" of SharePoint highlighted.](./assets/From-Workflow-Apps-to-Power-Automate/From-Workflow-Apps-to-Power-Automate-SPO-UI-07.png)
...
![The Microsoft Power Automate designer to select a value from the flow context or to define a dynamic expression. There are pre-defined fields like for example the ID of the item that triggered the flow instance.](./assets/From-Workflow-Apps-to-Power-Automate/From-Workflow-Apps-to-Power-Automate-SPO-UI-08.png)
...
![The Microsoft Power Automate designer showing the *"Yes"* branch.](./assets/From-Workflow-Apps-to-Power-Automate/From-Workflow-Apps-to-Power-Automate-SPO-UI-09.png)
...
![The Microsoft Power Automate tool to track the running process of a flow. There is the approval flow that is waiting for the actual approval.](./assets/From-Workflow-Apps-to-Power-Automate/From-Workflow-Apps-to-Power-Automate-SPO-UI-10.png)
...
![The Microsoft Teams Approval interface with an approval task assigned to the current user.](./assets/From-Workflow-Apps-to-Power-Automate/From-Workflow-Apps-to-Power-Automate-SPO-UI-11.png)
...
![The command available in SharePoint Online to go to the Power Automate dashboard. There is a *"Power Automate"* -> *"See your flows"* command under the *"Integrate"* command.](./assets/From-Workflow-Apps-to-Power-Automate/From-Workflow-Apps-to-Power-Automate-SPO-UI-13.png)
...
![The dashboard of a single flow in the Power Automate portal. There are general information about the flow, the connections of the flow, and the history of executions for the last 28 days.](./assets/From-Workflow-Apps-to-Power-Automate/From-Workflow-Apps-to-Power-Automate-SPO-UI-14.png)
...
![The diagram with the execution of a flow instance with details about every single action executed, as well as the inputs and outputs of every action.](./assets/From-Workflow-Apps-to-Power-Automate/From-Workflow-Apps-to-Power-Automate-SPO-UI-15.png)
...
![The command button to create a new *"Automated cloud flow"* from the list of *"My flows"* in the Power Automate portal.](./assets/From-Workflow-Apps-to-Power-Automate/From-Workflow-Apps-to-Power-Automate-Maker-UI-01.png)
...
![The dialog window to select the trigger condition for a new *"Automated cloud flow"*. There are plenty of options to automatically trigger a flow, including triggers related to SharePoint items or documents.](./assets/From-Workflow-Apps-to-Power-Automate/From-Workflow-Apps-to-Power-Automate-Maker-UI-02.png)
