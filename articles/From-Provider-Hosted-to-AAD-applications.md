...
[![IMAGE_ALT](https://img.youtube.com/vi/a1snL_hc94k/0.jpg)](https://youtu.be/a1snL_hc94k)
...
Start from scratch and using Microsoft Visual Studio 2022 create a new ASP.NET core web application, using for example .NET 6.0 and Razor. When you create such an application, you can choose to use the *"Microsoft identity platform"* as the authentication layer, like you can see in the following screenshot. 

![The UI of Microsoft Visual Studio 2022 when creating a new ASP.NET Core application. There is .NET 6.0 LTS selected and "Microsoft Identity Platform" as the selected authentication layer.](./assets/From-Provider-Hosted-to-AAD-applications/From-Provider-Hosted-to-AAD-applications-VS2022-Wizard-01.png)
...
![The UI of Microsoft Visual Studio 2022 prompting to install the "dotnet msidentity tool" to configure authentication.](./assets/From-Provider-Hosted-to-AAD-applications/From-Provider-Hosted-to-AAD-applications-VS2022-Wizard-02.png)
...
![The UI of Microsoft Visual Studio 2022 when configuring authentication with Azure AD. You can select the target tenant and you can register a new Azure AD application that will be associated with your application.](./assets/From-Provider-Hosted-to-AAD-applications/From-Provider-Hosted-to-AAD-applications-VS2022-Wizard-03.png)
...
![The "API permissions" page of the Azure AD application with a SharePoint Online delegated permission granted.](./assets/From-Provider-Hosted-to-AAD-applications/From-Provider-Hosted-to-AAD-applications-AAD-app-permissions.png)
